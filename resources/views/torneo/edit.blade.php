...
<script>
    window.addEventListener('DOMContentLoaded', function() {
        ...
        function agregarInputEquipo(e) {
            ...
            modeloEquipo.parentNode.insertBefore(modeloEquipo.cloneNode(true), boton.parentNode.parentNode);
        }
        ...
        function agregarInputPartido(e) {
            ...
            modeloPartido.parentNode.insertBefore(modeloPartido.cloneNode(true), boton.parentNode.parentNode);
        }
